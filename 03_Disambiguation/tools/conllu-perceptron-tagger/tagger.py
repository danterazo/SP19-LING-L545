...
class PerceptronTagger():
    ...
    # The following functtion was tweaked by Dante on
    def _get_features(self, i, word, context, prev, prev2):
        ...
        """ Dante's ideas: """
        # add('i+1 suffix', word[-2:])  # new
        # add('i+2 suffix', word[-1:])  # new
        # add('i-1 suffix', word[-4:])  # new
        # add('i-2 suffix', word[-5:])  # new
        # add('i tag', prev)  # new
        # add('i-2 tag', prev2)  # new
        # add('i-1 tag', prev)  # newS
        # add('i word', context[i])  # new
        # add('i-2 suffix', context[i - 2][-3:])  # new
        # add('i-3 word', context[i - 3])  # new
        # add('i-3 suffix', context[i - 3][-3:])  # new
        # add('i+2 suffix', context[i + 2][-3:])  # new
